...
interface ExtendedActionBarProps {
  ...
  onToggleDrawer?: () => void;
  filterOptions?: { value: string; label: string }[] | ((t: (ns: string, key: string, options?: any) => string) => { value: string; label: string }[]);
  showButtons?: {
    files?: boolean;
    add?: boolean;
    export?: boolean;
...
const DEFAULT_FILTER_OPTIONS = (t: (ns: string, key: string) => string): { value: string; label: string }[] => [
...
const ActionBar = ({
  ...
  const resolvedFilterOptions = typeof filterOptions === 'function' ? filterOptions(t) : filterOptions;
      ...
      >
        ...
        >
          <Box component="span" sx={{ display: "flex", alignItems: "center" }}>
            <Image src={SearchIcon} alt={t('common', 'actionBar.searchIconAlt')} width={16} />
          </Box>
          <InputBase
        ...
        >
          ...
          {hasExportPermission && <Button
            ...
            startIcon={<Image src={ExportDataIcon} alt={t('common', 'actionBar.exportDataIconAlt')} width={16} />}
          >
        ...
        >
          {showButtons.requests && (
            <Button
              ...
              startIcon={<Image src={RequestsIcon} alt={t('common', 'actionBar.requestIconAlt')} width={16} />}
            >
          ...
          {showButtons.files && (
            <Button
              ...
              startIcon={<Image src={LogFileIcon} alt={t('common', 'actionBar.logFileIconAlt')} width={16} />}
            >
          ...
          {showButtons.import && hasImportPermission && setShowUploadModal && (
            <Button
              ...
              startIcon={<Image src={ImportDataIcon} alt={t('common', 'actionBar.importDataIconAlt')} width={16} />}
            >
          ...
          {showButtons.comments && onToggleDrawer && (
            ...
            >
              <Image src={CommentIcon} alt={t('common', 'actionBar.commentIconAlt')} width={16} />
            </Button>
          )}
