...
import CityAutocompleteEditor from "@/pages/items-master-refactor/utils/cityAutoCompleteEditor";
import ContainerTypeEditor from "@/pages/items-master-refactor/utils/ContainerTypeEditor";
import { dateValidationRenderer } from "@/pages/items-master-refactor/utils/dateValidationRenderer";
import { HoverableTextRenderer } from "@/pages/items-master-refactor/utils/hoverableTextRenderer";
import { validationRules } from "@/pages/items-master-refactor/utils/validationRules";
...
export function getColumnHeaders({
    ...
    return headers.map((header, colIndex) => {
        ...
        if (colIndex === 2) {
            ...
            columnConfig.allowInvalid = false;
            columnConfig.placeholder = "Select";
            columnConfig.renderer = dateValidationRenderer(addRowInprogress && hasFailedRow)
...
export function highlightCell(hot: any, row: number, col: number, error = false) {
