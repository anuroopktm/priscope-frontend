...
const CommentSidebar: React.FC<CommentSidebarProps> = ({
  ...
  const { data, isLoading, error } = useListFreightRateComments({
    tenant_id: tenantId,
    search: searchValue,
    skip: page * PAGE_SIZE,
    page_size: PAGE_SIZE,
      ...
      <Box
        ...
        sx={{
          ...
          "&::-webkit-scrollbar-track": {
            background: "transparent", // or a light gray if you want
          },
            ...
            <Box
              ...
              onClick={() =>
                onCommentSelect?.({
                  ...
                  freight_rate_id: original.freight_rate_id,
                  comment_type: original.comment_type,
                  freight_field_key: original.freight_field_key,
                })
              }
            >
              {/* Avatar */}
