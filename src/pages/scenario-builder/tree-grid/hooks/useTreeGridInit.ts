...
export const useTreeGridInit = (
    ...
    // Create grid once
    useEffect(() => {
        console.log("useTreeGridInit: useEffect [layout, data, gridId, containerId]", { layout, data, gridId, containerId });
        ...
        console.log("useTreeGridInit: Calling window.TreeGrid with source:", source);
        try {
